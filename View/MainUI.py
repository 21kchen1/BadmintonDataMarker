...
class Ui_DataMarker(object):
    def setupUi(self, DataMarker):
        ...
        self.AcceRadioButton = QtWidgets.QRadioButton(self.widget_10)
        self.AcceRadioButton.setChecked(False)
        self.AcceRadioButton.setObjectName("AcceRadioButton")
        self.gridLayout_2.addWidget(self.AcceRadioButton, 0, 1, 1, 1)
        self.GyroRadioButton = QtWidgets.QRadioButton(self.widget_10)
        self.GyroRadioButton.setObjectName("GyroRadioButton")
        self.gridLayout_2.addWidget(self.GyroRadioButton, 1, 1, 1, 1)
        self.RotateRadioButton = QtWidgets.QRadioButton(self.widget_10)
        self.RotateRadioButton.setObjectName("RotateRadioButton")
        self.gridLayout_2.addWidget(self.RotateRadioButton, 1, 0, 1, 1)
    ...
    def retranslateUi(self, DataMarker):
        ...
        self.AcceRadioButton.setText(_translate("DataMarker", "Acce"))
        self.GyroRadioButton.setText(_translate("DataMarker", "Gyro"))
        self.RotateRadioButton.setText(_translate("DataMarker", "Rotate"))
