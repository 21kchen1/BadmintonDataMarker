...
class Ui_DataMarker(object):
    def setupUi(self, DataMarker):
        ...
        self.ProgressSetWidget = QtWidgets.QWidget(self.SetWidget)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(9)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.ProgressSetWidget.setFont(font)
        self.ProgressSetWidget.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.ProgressSetWidget.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ProgressSetWidget.setStyleSheet("")
        self.ProgressSetWidget.setObjectName("ProgressSetWidget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.ProgressSetWidget)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.ProgressSetLabel = QtWidgets.QLabel(self.ProgressSetWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ProgressSetLabel.sizePolicy().hasHeightForWidth())
        self.ProgressSetLabel.setSizePolicy(sizePolicy)
        self.ProgressSetLabel.setObjectName("ProgressSetLabel")
        self.verticalLayout_3.addWidget(self.ProgressSetLabel)
        self.widget_2 = QtWidgets.QWidget(self.ProgressSetWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.TimeSpinBox.setSingleStep(100)
        ...
        self.horizontalLayout_2.addWidget(self.ProgressSetWidget)
        ...
        self.AcceCheckBox = QtWidgets.QCheckBox(self.widget_10)
        self.AcceCheckBox.setObjectName("AcceCheckBox")
        self.gridLayout_2.addWidget(self.AcceCheckBox, 0, 1, 1, 1)
        ...
        self.RotateCheckBox = QtWidgets.QCheckBox(self.widget_10)
        self.RotateCheckBox.setObjectName("RotateCheckBox")
        self.gridLayout_2.addWidget(self.RotateCheckBox, 1, 0, 1, 1)
        self.GyroCheckBox = QtWidgets.QCheckBox(self.widget_10)
        self.GyroCheckBox.setObjectName("GyroCheckBox")
        self.gridLayout_2.addWidget(self.GyroCheckBox, 1, 1, 1, 1)
        ...
        self.XCheckBox = QtWidgets.QCheckBox(self.widget_9)
        self.XCheckBox.setObjectName("XCheckBox")
        self.gridLayout_3.addWidget(self.XCheckBox, 0, 1, 1, 1)
        self.YCheckBox = QtWidgets.QCheckBox(self.widget_9)
        self.YCheckBox.setObjectName("YCheckBox")
        self.gridLayout_3.addWidget(self.YCheckBox, 1, 0, 1, 1)
        self.ZCheckBox = QtWidgets.QCheckBox(self.widget_9)
        self.ZCheckBox.setObjectName("ZCheckBox")
        self.gridLayout_3.addWidget(self.ZCheckBox, 1, 1, 1, 1)
        ...
        self.lineEdit = QtWidgets.QLineEdit(self.widget_18)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_2 = QtWidgets.QLineEdit(self.widget_18)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, DataMarker):
        ...
        self.pushButton.setText(_translate("DataMarker", "Play"))
        ...
        self.pushButton_2.setText(_translate("DataMarker", "Apply"))
        self.AcceCheckBox.setText(_translate("DataMarker", "Acce"))
        self.DataTypeLabel.setText(_translate("DataMarker", "Data Type"))
        self.RotateCheckBox.setText(_translate("DataMarker", "Rotate"))
        self.GyroCheckBox.setText(_translate("DataMarker", "Gyro"))
        self.DataTypeLabel_2.setText(_translate("DataMarker", "Axis"))
        self.XCheckBox.setText(_translate("DataMarker", "X"))
        self.YCheckBox.setText(_translate("DataMarker", "Y"))
        self.ZCheckBox.setText(_translate("DataMarker", "Z"))
        ...
        self.pushButton_3.setText(_translate("DataMarker", "Save"))
