...
class Ui_DataMarker(object):
    def setupUi(self, DataMarker):
        ...
        self.StartSucceedButton = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.StartSucceedButton.sizePolicy().hasHeightForWidth())
        self.StartSucceedButton.setSizePolicy(sizePolicy)
        self.StartSucceedButton.setMaximumSize(QtCore.QSize(0, 0))
        self.StartSucceedButton.setStyleSheet("width: 0;\n"
"")
        self.StartSucceedButton.setText("")
        self.StartSucceedButton.setObjectName("StartSucceedButton")
        self.horizontalLayout_4.addWidget(self.StartSucceedButton)
